...
alias wotenv="source ~/python-envs/wot-env/bin/activate"
...
#export PS0='\[\e[0;36m\]\t\[\e[0m\] \[\e[0;31m\]\h\[\e[0m\] {\[\e[1;33m\]\w\[\e[0m\]}\[\e[0;36m\]\[\e[0m\]$'
#export PS1='\[\e[0;36m\]\t\[\e[0m\] \[\e[0;31m\]\h\[\e[0m\] {\[\e[1;33m\]\w\[\e[0m\]}\[\e[0;36m\]\[\e[0m\]$'
#export PROMPT_COMMAND='export PS1=$([ "$VIRTUAL_ENV" == "" ] || basename ${VIRTUAL_ENV})${VIRTUAL_ENV:+*}$(gitprompt.pl statuscount=1 u=%[%e[31m%] c=%[%e[32m%] f=%[%e[1\;37m%])'
